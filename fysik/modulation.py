...
class Modulation(MovingCameraScene, Slide if slides else Scene):
    ...
    def am_modulering(self):
        ...
        self.add(planes, message_wave, carrier_wave, am_wave)
        self.slide_pause()
        ...
        self.slide_pause()
        self.play(
            carrier_lambda_tracker.animate.set_value(10),
            run_time=5,
            # rate_func=rate_functions.linear
        )
        self.slide_pause()
        ...
        self.play(
            message_lambda_tracker.animate.set_value(2),
            run_time=5
        )
        self.slide_pause()

        self.play(
            message_lambda_tracker.animate.set_value(4),
            run_time=5
        )
        self.slide_pause()
